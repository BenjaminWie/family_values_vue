...
function __VLS_template() {
  ...
  if (__VLS_ctx.show) {
    __VLS_elementAsFunction(
      ...
      __VLS_intrinsicElements.div
    )({ ...{ onClick: __VLS_ctx.close }, ...{ class: 'modal-backdrop' } })
    __VLS_elementAsFunction(
      __VLS_intrinsicElements.div,
      __VLS_intrinsicElements.div
    )({ ...{ class: 'modal-content' } })
    __VLS_elementAsFunction(
      ...
      __VLS_intrinsicElements.button
    )({ ...{ onClick: __VLS_ctx.close }, ...{ class: 'close-button' }, 'aria-label': 'closeModal' })
    // @ts-ignore
    ;[show, close, close]
    __VLS_elementAsFunction(
      __VLS_intrinsicElements.div,
      ...
      ...{ class: 'value-header' },
      ...{ style: { background: __VLS_ctx.selectedValue.gradient } }
    })
    __VLS_elementAsFunction(__VLS_intrinsicElements.img)({
      src: __VLS_ctx.selectedValue.image,
      alt: 'Value Image',
      ...{ class: 'value-image' }
    })
    // @ts-ignore
    ...
    for (const [story, index] of __VLS_getVForSourceType(__VLS_ctx.selectedValue.stories)) {
      ...
      if (story.dataLink) {
        __VLS_elementAsFunction(
          ...
          __VLS_intrinsicElements.a
        )({ href: story.dataLink, target: '_blank', ...{ class: 'data-link' } })
      }
    }
    __VLS_elementAsFunction(
      __VLS_intrinsicElements.div,
    ...
    for (const [narrative, index] of __VLS_getVForSourceType(__VLS_ctx.selectedValue.narratives)) {
      __VLS_elementAsFunction(
        __VLS_intrinsicElements.div,
        __VLS_intrinsicElements.div
      )({ key: index, ...{ class: 'narrative-card' } })
      __VLS_elementAsFunction(
        __VLS_intrinsicElements.div,
        __VLS_intrinsicElements.div
      ...
      if (narrative.dataLink) {
        __VLS_elementAsFunction(
          __VLS_intrinsicElements.a,
          __VLS_intrinsicElements.a
        )({ href: narrative.dataLink, target: '_blank', ...{ class: 'data-link' } })
      }
    }
  }
