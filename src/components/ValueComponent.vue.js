...
function __VLS_template() {
  ...
  __VLS_elementAsFunction(
    ...
    ...{ onMouseover: __VLS_ctx.hoverValue },
    ...{ onMouseleave: __VLS_ctx.resetValue },
    ...{ onClick: __VLS_ctx.toggleExpand },
    ...{ class: 'value' },
    ...{ class: { 'expanded-once': __VLS_ctx.expandedOnce } }
  })
  ...
  if (__VLS_ctx.expandedOnce) {
    ...
    for (const [item, index] of __VLS_getVForSourceType(__VLS_ctx.floatingItems)) {
      __VLS_elementAsFunction(
        ...
        ...{
          onClick: (...[$event]) => {
            if (!__VLS_ctx.expandedOnce) return
        ...
        key: item.title,
        ...{ style: __VLS_ctx.floatingStyles[index] },
        ...{ class: 'floating-item' }
      })
      __VLS_elementAsFunction(
        __VLS_intrinsicElements.h3,
        __VLS_intrinsicElements.h3
      )({ ...{ class: item.type === 'narrative' ? 'narrative-title' : 'story-title' } })
