...
function __VLS_template() {
    ...
    for (const [value] of __VLS_getVForSourceType((__VLS_ctx.translatedValues))) {
        __VLS_elementAsFunction(__VLS_intrinsicElements.section, __VLS_intrinsicElements.section)({ ...{ onClick: (...[$event]) => {
                    __VLS_ctx.openModal(value);
                    // @ts-ignore
                    [translatedValues, openModal,];
                } }, key: ((value.id)), ...{ class: ("value-section") }, });
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("value-content") }, });
        __VLS_elementAsFunction(__VLS_intrinsicElements.img)({ src: ((value.image)), alt: ("Value Image"), ...{ class: ("value-image") }, });
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({ ...{ class: ("value-card") }, });
    ...
    if (__VLS_ctx.showModal) {
        ...
        [Modal, Modal,];
        // @ts-ignore
        const __VLS_7 = __VLS_asFunctionalComponent(__VLS_6, new __VLS_6({ ...{ 'onCloseModal': {} }, show: ((__VLS_ctx.showModal)), selectedValue: ((__VLS_ctx.selectedValue)), }));
        const __VLS_8 = __VLS_7({ ...{ 'onCloseModal': {} }, show: ((__VLS_ctx.showModal)), selectedValue: ((__VLS_ctx.selectedValue)), }, ...__VLS_functionalComponentArgsRest(__VLS_7));
